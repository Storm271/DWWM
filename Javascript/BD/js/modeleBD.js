...
// SEARCH BY SERIE------------------------------------------------------------------------
searchBySerie.addEventListener("change", function () {
  if (this.checked) {
    searchByAuteur.checked = false;
    searchByTitre.checked = false;
    type = "Serie";
  } else {
    type = "";
  }
...
// SEARCH BY AUTEUR------------------------------------------------------------------------
searchByAuteur.addEventListener("change", function () {
  if (this.checked) {
    searchBySerie.checked = false;
    searchByTitre.checked = false;
    type = "Auteur";
  } else {
    type = "";
...
// SEARCH BY TITRE------------------------------------------------------------------------
searchByTitre.addEventListener("change", function () {
  if (this.checked) {
    searchBySerie.checked = false;
    searchByAuteur.checked = false;
    type = "Titre";
